$key  = "HKU:\S-1-5-21-1367034019-3847259187-1284980668-1000\SOFTWARE\Microsoft\Internet Explorer\BrowserEmulation\ClearableListData"
$item = "UserFilter"
...
# $domains = @("google.com","musicsales.co.uk")
$domains = @()
$domains = {$domains}.Invoke() # Gets rid of the fixed size issue
